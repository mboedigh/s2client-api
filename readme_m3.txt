...
I had to manually edit ip6-parser (For reasons of my own, I have an updated v1.2 and it doesn't compile out of the box, the one that comes with s2client-api does not have a problem). 
...
sc2utils gives warnings: I don't use the output of this project, but here is what you do to compile them
